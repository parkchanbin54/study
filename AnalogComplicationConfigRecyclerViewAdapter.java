...
//import com.example.android.wearable.watchface.model.AnalogComplicationConfigData.ColorConfigItem2;
...
public class AnalogComplicationConfigRecyclerViewAdapter
    ...
    public AnalogComplicationConfigRecyclerViewAdapter(
        ...
        Log.d("tttt","tttttt");
        mSharedPref = context.getSharedPreferences(context.getString(R.string.analog_complication_preference_file_key), Context.MODE_PRIVATE);

        // Initialization of code to retrieve active complication data for the watch face.
        mProviderInfoRetriever = new ProviderInfoRetriever(mContext, Executors.newCachedThreadPool());
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        Log.d("when you click topnee","hi");
        ...
        switch (viewType) {
            ...
            case TYPE_COLOR_CONFIG:
                ...
                break;
            case HI:
                viewHolder= new Complication_Button(LayoutInflater.from(parent.getContext()).inflate(R.layout.config_list_complication_button,parent,false));
                break;
            case HI2:
                viewHolder= new Complication_Button2(LayoutInflater.from(parent.getContext()).inflate(R.layout.config_list_complication_button2,parent,false));
                break;
           /** case TYPE_BACKGROUND_COMPLICATION_IMAGE_CONFIG2:
                viewHolder =
                        new ColorPickerViewHolder(
                                LayoutInflater.from(parent.getContext())
                                        .inflate(R.layout.config_list_color_item, parent, false));
    ...
    public class PreviewAndComplicationsViewHolder extends RecyclerView.ViewHolder
        ...
        public void onClick(View view) {
            if (view.equals(mLeftComplication)) {
                ...
                Log.d("abc","leffffffffffffffffttttttttttt");
                Activity currentActivity = (Activity) view.getContext();
                Log.d("It is clicked","It clicked");
        ...
        private void launchComplicationHelperActivity(
            ...
            if (mSelectedComplicationId >= 0) {
                Log.d("when clicked","Clicked");
                int[] supportedTypes =
                        AnalogComplicationWatchFaceService.getSupportedComplicationTypes(
                                complicationLocation);
                ComponentName watchFace = new ComponentName(currentActivity, AnalogComplicationWatchFaceService.class);
                Intent intent=new Intent(currentActivity,AnalogComplicationConfigActivity.class);
                currentActivity.startActivityForResult(intent,123);
                //currentActivity.startActivityForResult(ComplicationHelperActivity.createProviderChooserHelperIntent(currentActivity, watchFace, mSelectedComplicationId, supportedTypes), AnalogComplicationConfigActivity.COMPLICATION_CONFIG_REQUEST_CODE);
        ...
        public void updateComplicationViews(
            ...
            if (watchFaceComplicationId == mBackgroundComplicationId) {
                if (complicationProviderInfo != null) {
                    ...
                    mWatchFaceBackgroundPreviewImageView.getBackground().setColorFilter(backgroundColorFilter);
        ...
        private void updateComplicationView(ComplicationProviderInfo complicationProviderInfo,
            ...
            if (complicationProviderInfo != null) {
                ...
                button.setContentDescription(mContext.getString(R.string.edit_complication,complicationProviderInfo.appName + " " +complicationProviderInfo.providerName));
        ...
        public void initializesColorsAndComplications() {
            ...
            String highlightSharedPrefString = mContext.getString(R.string.saved_marker_color);
            int currentHighlightColor = mSharedPref.getInt(highlightSharedPrefString, Color.WHITE);
    ...
    public class Complication_Button extends RecyclerView.ViewHolder implements OnClickListener{
        private Button mComplicationButton;
        private String mSharedPrefResourceString;
        public View thview;
        public Complication_Button(View view) {
            super(view);
            mComplicationButton = (Button) view.findViewById(R.id.complication_button);
            Log.d("AnalogComplicationConfigRecyclerViewAdapter","ColorPickerViewHolder");
            view.setOnClickListener(this);
            Log.d("View is this!!!!!!!!", String.valueOf(thview));
        }
        @Override
        public void onClick(View view) {
            Log.d("clicked","clicked");
            int color=Integer.parseInt(((AnalogComplicationConfigActivity)AnalogComplicationConfigActivity.context).color2);
            Log.d("AnalogCOmplicatied ",String.valueOf(color));
            ...
            Log.d("SharedPReferences : ", String.valueOf(sharedPref));

            SharedPreferences.Editor editor = sharedPref.edit();

            Log.d("editselectedcolor", String.valueOf(color));
            editor.putInt("saved_background_color",color);
            editor.commit();
            Log.d("color change determi++ne", "color change determine");
    ...
    public class Complication_Button2 extends RecyclerView.ViewHolder implements OnClickListener{
        private Button mComplicationButton;
        private String mSharedPrefResourceString;
        public View thview;
        public Complication_Button2(View view) {
            super(view);
            mComplicationButton = (Button) view.findViewById(R.id.complication_button2);
            Log.d("22222222222222","ColorPickerViewHolder");
            view.setOnClickListener(this);
            Log.d("22222222222222", String.valueOf(thview));
        }
        @Override
        public void onClick(View view) {
            Log.d("clicked2","clicked2");
            int color=Integer.parseInt(((AnalogComplicationConfigActivity)AnalogComplicationConfigActivity.context).color);
            Log.d("AnalogCOmplicatied2 ",String.valueOf(color));
            // Pass shared preference name to save color value to.
            //여기다
            Activity activity = (Activity) view.getContext();
            SharedPreferences sharedPref = activity.getSharedPreferences(
                    activity.getString(R.string.analog_complication_preference_file_key),
                    Context.MODE_PRIVATE);
            Log.d("SharedPReferences2 : ", String.valueOf(sharedPref));
    ...
    public class ColorPickerViewHolder extends RecyclerView.ViewHolder implements OnClickListener {
        ...
        private Class<ColorSelectionActivity2> mLaunchActivityToSelectColor2;
        ...
        public void setLaunchActivityToSelectColor2(Class<ColorSelectionActivity2> activity2) {
            mLaunchActivityToSelectColor2 = activity2;
        }
        @Override
        public void onClick(View view) {
            int position = getAdapterPosition();
            Log.d(TAG, "Complication onClick() position: " + position);
            //버튼 눌렀을때 마커 배경 화면 등 버튼 온클릭 액티비티
    ...
    public class BackgroundComplicationViewHolder extends RecyclerView.ViewHolder
        ...
        public void onClick(View view) {
            ...
            if (mSelectedComplicationId >= 0) {
                ...
                int[] supportedTypes = AnalogComplicationWatchFaceService.getSupportedComplicationTypes(ComplicationLocation.BACKGROUND);
