    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                Log.d("AnalogCOmplicatied ",color);
                ...
                Log.d("EditedSelectedcolor",String.valueOf(view.getContext()));

                SharedPreferences sharedPref = activity.getSharedPreferences(
                        activity.getApplicationContext().getString(R.string.analog_complication_preference_file_key),
                        Context.MODE_PRIVATE);

                SharedPreferences.Editor editor = sharedPref.edit();

                Log.d("editselectedcolor", String.valueOf(color));
                editor.putInt(sharedPrefString, Integer.parseInt(color));
                editor.commit();
                ...
                //launchIntent = new Intent(view.getContext(), mLaunchActivityEditSelectColor);
                //launchIntent.putExtra(EXTRA_SHARED_PREF,color);
